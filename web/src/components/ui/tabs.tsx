...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-card/50 text-muted-foreground inline-flex h-10 w-full items-center justify-center rounded-lg p-1 backdrop-blur border border-border/20",
        className
      )}
      {...props}
    />
